...
knitr::include_graphics('images/PipelineOverview.jpg')
```

While this analysis is useful, the overall purpose of this workshop is to teach 
users how to utilize a wide variety of tools for computational genomics. Our 
immediate  goal serves as a convenient mechanism to guide instruction in a set of 
broadly applicable tools that can easily be repurposed to many other problems.
...
| Working with Genomic Data                | `DECIPHER`|           10 min   |
| Gene Calling and Annotation              | `DECIPHER`|           15 min   |
| Finding COGs                             |`SynExtend`|           15 min   |
| Phylogenetic Reconstruction              | `DECIPHER`|           15 min   |
| Identifying Co-evolving Gene Collectives |`SynExtend`|           15 min   |
