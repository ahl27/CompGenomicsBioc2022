...
vignette: >
  %\VignetteIndexEntry{ComparativeGenomicsBioc2022}
...
Authors: Aidan Lakshman[^1], Nicholas Cooley[^1], Erik S. Wright[^1]. <br/> Last
...
The overall goal of the session is to use sequence data to uncover networks of 
...
While this analysis is useful, the purpose of this workshop is to teach users how
to utilize a wide variety of tools for computational genomics. Our overarching 
...
work on the code independently -- do not be too ambitious in the material
that you present.
