...
which you can download with the below button.
...
from GenBank and then reading them in individually. More details on this are 
available on the [Setup page](https://www.ahl27.com/CompGenomicsBioc2022/articles/Setup.html).
...
Seqs2DB(exStringSet, type='XStringSet', identifier=identifiers)
```
