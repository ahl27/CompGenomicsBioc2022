...
library(DECIPHER)
library(ape)
datafile <- system.file('extdata', 'phyloInputData', package='CompGenomicsBioc2022')
...
plot_tree_unrooted(treeMP)
treeNJ <- TreeLine(testSeqs, method='NJ')
plot_tree_unrooted(treeNJ)
