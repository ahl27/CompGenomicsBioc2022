...
knitr::include_graphics('images/PipelineHomology.pdf')
```
...
performance. We also use `ExtractBy` to pull out the sequences corresponding to each
genomic region in each COG.
```{r results='hide'}
COGSets <- DisjointSet(Pairs = Pairs,
                        Verbose = TRUE)

# Extract sequences for COGs with at least orthologs
