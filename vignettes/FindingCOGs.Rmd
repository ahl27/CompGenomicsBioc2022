...
be using real *Micrococcus* genomes taken from NCBI. I've selected 5 genomes to
work with due to their relatively small size since we have limited time in this workshop. 
However, the complete data are available [here](https://www.ncbi.nlm.nih.gov/data-hub/genome/?taxon=1269&annotated_only=true&refseq_annotation=true&assembly_level=3%3A3),
...
provides an example of using prebuilt annotations.
