...
knitr::include_graphics('images/PipelineGeneCalling.jpg')
```
...
ExTrainList <- list(TrainingSet=trainingSet)
downloadthis::download_this(
  ExTrainList,
  output_name = 'IdTaxaActinobacteriaTraining',
...
```{r eval=FALSE}
# TrainingSet.RData is downloadable at the above link.
