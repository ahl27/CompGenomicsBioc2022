...
`MP` and `ML` denote Maximum Parsimony and Maximum Likelihood, respectively.
`ML` is more accurate than `MP`, but suffers in runtime. See the section on
[Phylogenetics](https://www.ahl27.com/CompGenomicsBioc2022/articles/ConstructingPhylogenies.html) for more info.


| Pipeline Stage        |  Scaling  | Single or Parallel | Example | Example Runtime |
|:-------------------:|:---------:|:---------:|:---------:|:-------:|
| Get Genomes     |  $O(G)$ |  Single  | 300 *Streptomyces* Genomes  |  30-120 sec |
| Find Genes     | $O(G)$ | Parallel | Single *Streptomyces* Genome | 10-20 min |
| Annotate Genes | $O(G)$ |  Parallel | Single *Streptomyces* Genome | 10-30 min |
| Pairwise Orthology | $O(G^2)$ | Parallel |  Pair of *Streptomyces* Genomes |  5-20 min |
| Ortholog Pairs to COGs   | $O(g^2)$ | Single |  All pairs from 300 *Streptomyces* Genomes | 5 min |
| Align and Make Tree (MP) | $O(C)$ | Parallel  |  Single *Streptomyces* COG | 20-40 min |
| Align and Make Tree (ML) | $O(C)$ | Parallel | Single *Streptomyces* COG | 10-12 hr |
| Calculate Coevolution | $O(C^2)$ | Parallel |  Pair of *Streptomyces* COGs | 5-10 sec |
