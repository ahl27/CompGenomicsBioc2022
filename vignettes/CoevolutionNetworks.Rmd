...
knitr::include_graphics('images/PipelineProtWeaver.jpg')
```
...
nickle/cobalt transporter. If we had conducted this analysis with hypothetical 
proteins, we could have inferred novel functions!
