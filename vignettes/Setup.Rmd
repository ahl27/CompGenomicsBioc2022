...
`DECIPHER` version `2.25.0` and `SynExtend` version `1.9.4`, which are available on
...
#BiocManager::install('DECIPHER', version='2.25.0')
#BiocManager::install('SynExtend', version='1.9.4')
